 ...
 * @author eduar
 */
public class Popup_infos_placca extends javax.swing.JFrame {

    /**
     * Creates new form Popup_infos_placca
     */
    public Popup_infos_placca() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Popup_infos_placca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Popup_infos_placca().setVisible(true);
            }
        });
    }
