 ...
 */
public class Mapa_1_marcador
{

    public Mapa_1_marcador(double lat, double lon) {
        //-23.51, -47.45
        mapa(lat,lon);
    }

    
    public static void mapa(double lat,double lon){        
        ...
        //location of Java
        final GeoPosition gp = new GeoPosition(lat, lon); 
